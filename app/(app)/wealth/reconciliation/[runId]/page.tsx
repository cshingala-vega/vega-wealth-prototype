...
export default async function ReconRunDetailPage({ params }: { params: Promise<{ runId: string }> }) {
  ...
  return (
    <ResultsClient
      run={{
        ...
        runDate: run.completedAt
          ? run.completedAt.toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" })
          : run.createdAt.toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" }),
